...
sys.path.append("..")
from paillier_exp import Paillier, PaillierKeyGenerator, CryptoNumber


class Test:
    @pytest.fixture()
    def set_up(self):
        print('start paillier exp tests')
        key_size = 2048
        ...
        print('finish paillier exp tests')
...
if __name__ == '__main__':
    pytest.main(['-s', '-rp', 'test_paillier_exp.py'])
