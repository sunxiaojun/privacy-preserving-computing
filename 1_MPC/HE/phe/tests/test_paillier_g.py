...
sys.path.append("..")
from paillier_g import Paillier, PaillierKeyGenerator, CryptoNumber


class Test:
    @pytest.fixture()
    def set_up(self):
        print('start paillier g tests')
        key_size = 2048
...
if __name__ == '__main__':
    pytest.main(['-s', '-rp', 'test_paillier_g.py'])
